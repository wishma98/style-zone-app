    ...
    <div className={"w-full h-full "}>
      <div className="w-full h-auto lg:h-[812px] md:h-dvh max-sm:h-dvh max-md:h-dvh ">
        <img
          ...
          src={require("../../assets/images/boarding1.png")}
          alt="landing"
        />
      </div>
      <div className="absolute w-full h-full lg:h-[812px] lg:top-0 max-md:min-w-full top-[30%] bottom-0 left-0 right-0 z-[9999] bg-overlay container flex flex-col justify-center items-center">
